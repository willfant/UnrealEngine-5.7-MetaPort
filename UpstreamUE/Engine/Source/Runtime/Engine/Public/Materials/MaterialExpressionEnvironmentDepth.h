...
class UMaterialExpressionEnvironmentDepth : public UMaterialExpression
{
	...
	/** 
	 * Coordinates - UV coordinates to apply to the environment depth lookup.
	 * OffsetFraction - An offset to apply to the environment depth lookup in a 2d fraction of the screen.
	 */
	 ...
	 * UV coordinates to apply to the environment depth lookup or
	 * an offset to apply to the environment depth lookup, in a 2d fraction of the screen.
	 */
