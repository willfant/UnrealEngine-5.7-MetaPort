...
public:
	...
	// Validation mode to allow different handling of material expressions during translation.
	void EnableValidationMode(bool bEnable) { bIsValidating = bEnable; }
...
public:
	...
	{
		return Compiler->MaterialCacheTextureDescriptor(Layout, PrimitiveIDIndex, LayerIndex);
	}
	...
	{
		return Compiler->SampleMaterialCache(Layout, PrimitiveIDIndex, TexCoordIndex);
	}
	
	virtual int32 DefaultMaterialCacheAttribute(const FMaterialCacheTagLayout& Layout) override
	{
		return Compiler->DefaultMaterialCacheAttribute(Layout);
	}
	...
	{
		return Compiler->SetMaterialCacheAttribute(Layout, AttributeSet, AttributeIndex, Value);
	}
	...
	{
		return Compiler->GetMaterialCacheAttribute(Layout, AttributeSet, AttributeIndex);
	}
	...
	{
		return Compiler->MaterialCacheOutput(CustomOutput, Layout, AttributeSet);
	}
