...
public:
	...
	virtual void Evict(FVulkanDevice& Device, const FVulkanContextArray& Contexts) { checkNoEntry(); }
	virtual void Move(FVulkanDevice& Device, const FVulkanContextArray& Contexts, VulkanRHI::FVulkanAllocation& Allocation) { checkNoEntry(); }
...
// 			64 * 1024,
	...
	class FStagingBuffer : public FThreadSafeRefCountedObject
	{
	public:
