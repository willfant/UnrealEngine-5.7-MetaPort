...
private:
	...
	*/
	...
	/** When running multiple player windows, this option determins extra parameters to be include as part of the command line for each player AND this will hide "Additional Launch Parameters" for the standalone game. */
	UPROPERTY(config, EditAnywhere, Category = "Multiplayer Options", meta = (DisplayName = "Additional Launch Parameters For MultiPlayer"))
	TArray<FString> MPAdditionalLaunchParameters;
...
public:
	...
	// BEGIN META SECTION - VR MultiPlayer
	TArray<FString>& GetMPAdditionalLaunchParameters() { return MPAdditionalLaunchParameters; }
	// END META SECTION - VR MultiPlayer
