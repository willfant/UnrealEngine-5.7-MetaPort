...
namespace DecalRendering
{
	...
	// BEGIN META SECTION - Decal Rendering VS Compute Reduction
	void SetShader(FRHICommandList& RHICmdList, FGraphicsPipelineStateInitializer& GraphicsPSOInit, uint32 StencilRef, const FViewInfo& View, const FVisibleDecal& DecalData, EDecalRenderStage DecalRenderStage, const FMatrix* FrustumComponentToClip, uint32 FrustumComponentToClipNum, const FScene* Scene = nullptr);
	// END META SECTION - Decal Rendering VS Compute Reduction
};