...
// BEGIN META SECTION - Disable Orientation Polling
static int32 GAndroidDisableOrientationPolling = 0;
static FAutoConsoleVariableRef CVarDisableOrientationPolling(
	TEXT("r.Android.DisableOrientationPolling"),
	GAndroidDisableOrientationPolling,
	...
	ECVF_ReadOnly);
// END META SECTION - Disable Orientation Polling
...
void FAndroidApplication::PollGameDeviceState( const float TimeDelta )
{
	...
	// BEGIN META SECTION - Disable Orientation Polling
	if (!GAndroidDisableOrientationPolling)
	{
