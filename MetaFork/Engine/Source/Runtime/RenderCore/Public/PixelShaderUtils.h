...
struct FPixelShaderUtils
{
		...
		uint32 StencilRef = 0)
	{
		...
		{
			RHICmdList.SetStereoViewport((float)Viewport.Min.X, (float)Viewport.Min.X, (float)Viewport.Min.Y, (float)Viewport.Min.Y, 0.0f, (float)Viewport.Max.X, (float)Viewport.Max.X, (float)Viewport.Max.Y, (float)Viewport.Max.Y, 1.0f);
			RHICmdList.SetStereoScissor((float)Viewport.Min.X, (float)Viewport.Min.X, (float)Viewport.Min.Y, (float)Viewport.Min.Y, (float)Viewport.Max.X, (float)Viewport.Max.X, (float)Viewport.Max.Y, (float)Viewport.Max.Y);
		}
