...
// BEGIN META SECTION - Emulated Uniform Buffers
	...
	FString Contents = UE::ShaderCompilerCommon::GetDebugShaderContents(InternalState.Input, SourceString, DebugOptions);
	FFileHelper::SaveStringToFile(Contents, *DebugOptions.GetDebugShaderPath(InternalState.Input));
// END META SECTION - Emulated Uniform Buffers
}
