...
public:
	...
	OPENXRHMD_API virtual void SetTrackingPositionEnabled(const int32 DeviceId, bool bEnable) = 0;
	OPENXRHMD_API virtual void SetTrackingOrientationEnabled(const int32 DeviceId, bool bEnable) = 0;
