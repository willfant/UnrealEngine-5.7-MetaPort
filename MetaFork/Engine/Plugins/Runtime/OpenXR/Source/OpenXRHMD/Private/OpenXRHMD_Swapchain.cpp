...
{
	check(IsInRenderingThread() || IsInRHIThread() || IsInParallelRHIThread());
...
// BEGIN META SECTION - Add XR Cubemap Support
	ETextureCreateFlags SanitizedCreateFlags = SanitizeTextureCreateFlags(CreateFlags);
	for (const auto& Image : Images)
	{
		switch (Dimension)
		{
		case ETextureDimension::Texture2D:
			TextureChain.Add(D3D11RHI->RHICreateTexture2DFromResource(GPixelFormats[Format].UnrealFormat, SanitizedCreateFlags, ClearValueBinding, Image.texture));
			break;
		case ETextureDimension::Texture2DArray:
			TextureChain.Add(D3D11RHI->RHICreateTexture2DArrayFromResource(GPixelFormats[Format].UnrealFormat, SanitizedCreateFlags, ClearValueBinding, Image.texture));
			break;
		case ETextureDimension::TextureCube:
			TextureChain.Add(D3D11RHI->RHICreateTextureCubeFromResource(GPixelFormats[Format].UnrealFormat, SanitizedCreateFlags, ClearValueBinding, Image.texture));
			break;
		default:
			return nullptr;
		}
...
// BEGIN META SECTION - Add XR Cubemap Support
	...
	for (const auto& Image : Images)
	{
		...
		{
		case ETextureDimension::Texture2D:
			TextureChain.Add(DynamicRHI->RHICreateTexture2DFromResource(GPixelFormats[Format].UnrealFormat, SanitizedCreateFlags, ClearValueBinding, Image.texture));
			break;
		case ETextureDimension::Texture2DArray:
			TextureChain.Add(DynamicRHI->RHICreateTexture2DArrayFromResource(GPixelFormats[Format].UnrealFormat, SanitizedCreateFlags, ClearValueBinding, Image.texture));
			break;
		case ETextureDimension::TextureCube:
			TextureChain.Add(DynamicRHI->RHICreateTextureCubeFromResource(GPixelFormats[Format].UnrealFormat, SanitizedCreateFlags, ClearValueBinding, Image.texture));
		}
	}
// END META SECTION - Add XR Cubemap Support
	return CreateXRSwapChain<FOpenXRSwapchain>(MoveTemp(TextureChain), (FTextureRHIRef&)TextureChain[0], Swapchain);
...
// BEGIN META SECTION - Add XR Cubemap Support
	...
	for (const auto& Image : Images)
	{
		...
		{
		case ETextureDimension::Texture2D:
			TextureChain.Add(DynamicRHI->RHICreateTexture2DFromResource(GPixelFormats[Format].UnrealFormat, SizeX, SizeY, NumMips, NumSamples, 1, ClearValueBinding, Image.image, SanitizedCreateFlags));
			break;
		case ETextureDimension::Texture2DArray:
			TextureChain.Add(DynamicRHI->RHICreateTexture2DArrayFromResource(GPixelFormats[Format].UnrealFormat, SizeX, SizeY, ArraySize, NumMips, NumSamples, 1, ClearValueBinding, Image.image, SanitizedCreateFlags));
			break;
		case ETextureDimension::TextureCube:
			TextureChain.Add(DynamicRHI->RHICreateTextureCubeFromResource(GPixelFormats[Format].UnrealFormat, SizeX, false, NumMips, 1, NumSamples, 1, ClearValueBinding, Image.image, SanitizedCreateFlags));
			break;
		default:
			return nullptr;
		}
...
// BEGIN META SECTION - Add XR Cubemap Support
		...
		{
		case ETextureDimension::Texture2D:
			TextureChain.Add(VulkanRHI->RHICreateTexture2DFromResource(GPixelFormats[Format].UnrealFormat, SizeX, SizeY, NumMips, NumSamples, Image.image, SanitizedCreateFlags, ClearValueBinding));
			break;
		case ETextureDimension::Texture2DArray:
			TextureChain.Add(VulkanRHI->RHICreateTexture2DArrayFromResource(GPixelFormats[Format].UnrealFormat, SizeX, SizeY, ArraySize, NumMips, NumSamples, Image.image, SanitizedCreateFlags, ClearValueBinding));
			break;
		case ETextureDimension::TextureCube:
			TextureChain.Add(VulkanRHI->RHICreateTextureCubeFromResource(GPixelFormats[Format].UnrealFormat, SizeX, false, 1 , NumMips, Image.image, SanitizedCreateFlags, ClearValueBinding));
			break;
		default:
			return nullptr;
		}
